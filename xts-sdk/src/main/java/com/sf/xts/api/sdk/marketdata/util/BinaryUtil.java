...
//        long tokenID = (long) reader.getDouble();
...
//
//        count = BinaryUtil.deserialize(reader, count,md);
//        touchline.setBidMarketDeptRow(md);
//
//        MarketDeptRowInfo md1 = new MarketDeptRowInfo();
//
//        count = deserialize(reader, count,md1);
//        touchline.setAskMarketDeptRow(md1);
//
//        Long lut = reader.getLong();
//        touchline.setLut(lut);
//        count += 8;
//
//        double LTP = reader.getDouble();
//        touchline.setLTP(LTP);
//        count += 8;
//
//        long ltq = reader.getLong();
//        touchline.setLtq(ltq);
//        count += 8;
//
//        long totalBuyQuantity = reader.getLong();
//        touchline.setTotalBuyQuantity(totalBuyQuantity);
//        count += 8;
//
//        long totalSellQuantity = reader.getLong();
//        touchline.setTotalSellQuantity(totalSellQuantity);
//        count += 8;
//
//        long totalTradedQuantity = reader.getLong();
//        touchline.setTotalTradedQuantity(totalTradedQuantity);
//        count += 8;
//
//        double averageTradedPrice = reader.getDouble();
//        touchline.setAverageTradedPrice(averageTradedPrice);
//        count += 8;
//
...
//        count += 8;
//
//        double percentChange = reader.getDouble();
//        touchline.setPercentChange(percentChange);
//        count += 8;
//
//        double open = reader.getDouble();
//        touchline.setOpen(open);
//        count += 8;
//
//        double high = reader.getDouble();
//        touchline.setHigh(high);
//        count += 8;
//
//        double low = reader.getDouble();
//        touchline.setLow(low);
//        count += 8;
//
//        double close = reader.getDouble();
//        touchline.setClose(close);
//        count += 8;
//
//        double totalValueTraded = reader.getDouble();
//        touchline.setTotalValueTraded(totalValueTraded);
//        // System.out.println("skiptotalvaluetraded: " + totalValueTraded);
//        count += 8;
//
...
//        counter += 8;
//
//        //  rowPrice = reader.getDouble();// Assuming readUInt64 reads 8 bytes
//        info.setRowPrice(reader.getDouble());
//        counter += 8;
//
//        //  totalOrders = reader.getInt();
//        info.setTotalOrders(reader.getInt());
//        counter += 4;
//
//        // backMarketMakerFlag = reader.getShort();
