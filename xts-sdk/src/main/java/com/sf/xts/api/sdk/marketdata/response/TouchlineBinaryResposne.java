...
public class TouchlineBinaryResposne {
    ...
    double averageTradedPrice; // was int in protocol → divided by divisor
    long lastTradedTime;
    ...
    // REMOVED: double totalValueTraded;  // field no longer in new update
...
//                ", bidMarketDeptRow=" + bidMarketDeptRow +
//                ", askMarketDeptRow=" + askMarketDeptRow +
                ", lut=" + lut +
                ", LTP=" + LTP +
                ", ltq=" + ltq +
